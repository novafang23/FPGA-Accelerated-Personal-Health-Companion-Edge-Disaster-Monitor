...
HD_PWD='C:/Users/abhin/OneDrive/Desktop/verilog/SIH/FPGA accelerated medical device-SIH/FPGA accelerated medical device-SIH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ppg_accelerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_ppg_accelerator.tcl -notrace
