...
HD_PWD='C:/Users/abhin/OneDrive/Desktop/verilog/SIH/FPGA accelerated medical device-SIH/FPGA accelerated medical device-SIH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ppg_accelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_ppg_accelerator.tcl
