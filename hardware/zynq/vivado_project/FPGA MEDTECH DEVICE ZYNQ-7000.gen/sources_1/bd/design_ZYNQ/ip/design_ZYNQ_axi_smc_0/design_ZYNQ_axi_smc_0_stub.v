...
// Command     : write_verilog -force -mode synth_stub {c:/Users/abhin/OneDrive/Desktop/verilog/FPGA MEDTECH DEVICE
//               ZYNQ-7000/FPGA MEDTECH DEVICE
//               ZYNQ-7000.gen/sources_1/bd/design_ZYNQ/ip/design_ZYNQ_axi_smc_0/design_ZYNQ_axi_smc_0_stub.v}
...
(* CHECK_LICENSE_TYPE = "design_ZYNQ_axi_smc_0,bd_084c,{}" *) (* CORE_GENERATION_INFO = "design_ZYNQ_axi_smc_0,bd_084c,{x_ipProduct=Vivado 2026.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=29,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_084c,Vivado 2026.1" *) 
module design_ZYNQ_axi_smc_0(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
...
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_ZYNQ_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
